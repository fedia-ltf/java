...
//prosit 5
        ...
        */
        ...
        Zoo myZoo = new Zoo("MyZoo", "Tunis"); // Création du zoo

        myZoo.addAquaticAnimal(d1); // Ajout dauphin
        myZoo.addAquaticAnimal(p1); // Ajout pingouin
        myZoo.addAquaticAnimal(p2); // Ajout pingouin
